...
const [html, css, script, project, homepage, projectCard, image] = await Promise.all([
  ...
  readFile(new URL("_pages/about.md", root), "utf8"),
  readFile(new URL("_includes/projects.liquid", root), "utf8"),
...
requireText(project, "demo_url: /cooperboard/", "demo-first project destination");
requireText(homepage, 'class="featured-project" href="/cooperboard/"', "demo-first homepage link");
